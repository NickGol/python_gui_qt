...
grid1 = QtWidgets.QGridLayout()            # Создаем сетку
grid1.addWidget(button1, 0, 0, alignment=QtCore.Qt.AlignLeft)
grid1.addWidget(button2, 0, 1, QtCore.Qt.AlignRight)
grid1.addWidget(button3, 1, 0, 1, 2)

window.setLayout(grid1)                    # Передаем ссылку родителю
window.show()
sys.exit(app.exec_())
