...
class MyThread(QtCore.QThread):
    ...
    def __init__(self, id, queue, time=3, parent=None):
    ...
    def run(self):
        while True:
            ...
            self.sleep(self.time)                     # Имитируем обработку
...
class MyWindow(QtWidgets.QPushButton):
    def __init__(self):
        ...
        self.threads = []
        for i in range(1, 5):             # Создаем потоки и запускаем
            thread = MyThread(i, self.queue, i)
