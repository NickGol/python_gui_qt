...
from pyqtgraph.widgets.GraphicsView import *
from pyqtgraph.graphicsItems.PlotItem import *
# from ..Qt import QtCore, QtGui
# from .GraphicsView import *     MplWidget
# from ..graphicsItems.PlotItem import *

__all__ = ['MplWidget']
class MplWidget(GraphicsView):
    ...
    def __init__(self, parent=None, background='default', **kargs):
        ...
        self.setBackground([227, 255, 15, 10])
    ...
    def widgetGroupInterface(self):
        return (None, MplWidget.saveState, MplWidget.restoreState)
